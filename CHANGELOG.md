...
All notable changes to Nexus should be recorded in this file.
...
- `docs/SHOWCASE.md` with concrete Nexus usage patterns and demo commands.
...
- Initial public release of Nexus.
