...
from personal_agent.workspace import get_sessions_dir


def get_session_dir(workspace: str | Path | None = None) -> Path:
    """Return the nexus sessions directory."""
...
def save_session_snapshot(
    *,
    ...
    """Persist the latest nexus session snapshot."""
    session_dir = get_session_dir(workspace)
...
def export_session_markdown(
    *,
    ...
    parts = ["# nexus Session Transcript"]
...
class NexusSessionBackend(SessionBackend):
    """Session backend rooted in ``.nexus/sessions``."""
