...
from nexus.commands.registry import CommandContext, create_default_command_registry
...
from nexus.bridge import build_sdk_url, decode_work_secret, encode_work_secret, spawn_session
...
async def main() -> int:
    with tempfile.TemporaryDirectory(prefix="nexus-local-system-") as temp_dir:
