...
async def test_markdown_render() -> tuple[bool, str]:
    ...
    from nexus.ui.output import OutputRenderer
...
async def test_tool_output_format() -> tuple[bool, str]:
    ...
    from nexus.ui.output import OutputRenderer
    from nexus.engine.stream_events import ToolExecutionStarted, ToolExecutionCompleted
...
async def test_real_model_headless() -> tuple[bool, str]:
    ...
    from nexus.ui.app import run_print_mode
