"""Path resolution for Nexus configuration and data directories.

Follows XDG-like conventions with ~/.nexus/ as the default base directory.
"""
...
def get_config_file_path() -> Path:
    """Return the path to the main settings file (~/.nexus/settings.json)."""
...
def get_project_config_dir(cwd: str | Path) -> Path:
    """Return the per-project .nexus directory."""
    project_dir = Path(cwd).resolve() / ".nexus"
