"""Agent definition loading system for Nexus."""
...
def get_all_agent_definitions() -> list[AgentDefinition]:
    ...
    try:
        from nexus.plugins.loader import load_plugins  # noqa: PLC0415
        from nexus.config.settings import load_settings  # noqa: PLC0415
