...
from nexus.api.client import ApiMessageCompleteEvent, ApiMessageRequest, SupportsStreamingMessages
...
from nexus.hooks.types import AggregatedHookResult, HookResult
from nexus.sandbox import SandboxUnavailableError
from nexus.utils.shell import create_shell_subprocess
...
class HookExecutor:
    ...
    async def _run_prompt_like_hook(
        ...
        *,
        ...
        prefix = (
            "You are validating whether a hook condition passes in Nexus. "
