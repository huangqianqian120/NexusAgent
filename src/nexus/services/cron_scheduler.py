...
Runs as a standalone process (``nx cron start``) or can be embedded via
...
from nexus.config.paths import get_data_dir, get_logs_dir
from nexus.services.cron import (
    load_cron_jobs,
    mark_job_run,
...
# ---------------------------------------------------------------------------
# Daemon entry point (spawned by ``nx cron start``)
# ---------------------------------------------------------------------------
