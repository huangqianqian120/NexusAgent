...
from nexus.platforms import get_platform, get_platform_capabilities
from nexus.swarm.spawn_utils import is_tmux_available
from nexus.swarm.types import BackendDetectionResult, BackendType, TeammateExecutor
...
class BackendRegistry:
    ...
    def get_executor(self, backend: BackendType | None = None) -> TeammateExecutor:
        ...
        Returns:
            The registered :class:`~nexus.swarm.types.TeammateExecutor`.
    ...
    def _register_defaults(self) -> None:
        ...
        if get_platform_capabilities().supports_swarm_mailbox:
            from nexus.swarm.in_process import InProcessBackend
