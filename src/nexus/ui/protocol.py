...
from nexus.state.app_state import AppState
from nexus.bridge.manager import BridgeSessionRecord
from nexus.mcp.types import McpConnectionStatus
from nexus.tasks.types import TaskRecord
